...
function renderDesarrolloPlan() {
  ...
  const followupReports = [
    ...
    },
    {
      ...
      links: [
        { label: 'Control seguimiento consultoria 5 de 5', href: 'https://docs.google.com/document/d/13FWwMyOsvugAn7ylqS80Bcfdvh5HBmNu/edit?usp=sharing&ouid=100586482682251946947&rtpof=true&sd=true', icon: 'file-word' },
        { label: 'Plan de trabajo 5 de 5', href: 'https://docs.google.com/document/d/1bef-C_v1obGEhsUquHTVPrRzWvIWxToP/edit?usp=sharing&ouid=100586482682251946947&rtpof=true&sd=true', icon: 'file-word' },
      ],
    },
  ];
...
const CRONOGRAMA_PLAN_TRABAJO_20260615_TASKS = [
  { id: 'cr-f2-20260615-001', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Revisar lineamientos del articulo y comenzar redaccion', descripcion: 'Lineamientos del articulo enviados por Vanessa. Accionable del Plan de trabajo 1de4.', responsable: 'JAIME', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-19' },
  { id: 'cr-f2-20260615-002', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Gestionar firma original del tutor', descripcion: 'Firma original del tutor, sin perforar, en sobre manila. Enviar digital separado del informe.', responsable: 'JAIME', avance: 50, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-19' },
  { id: 'cr-f2-20260615-003', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Completar ficha MINEDUCYT', descripcion: 'Gestionar y completar la ficha del MINEDUCYT en formato Word de Vanessa.', responsable: 'JAIME', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-19' },
  { id: 'cr-f2-20260615-004', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Redactar politica formal de meta minima de produccion por odontologa', descripcion: 'Politica de meta minima de produccion de $2,500 mensuales. Si no se alcanza en 3 meses consecutivos, activar no renovacion de espacio. Compartir a Ricardo listado de odontologos y niveles de produccion para cuantificar costo de silla subutilizada.', responsable: 'JAIME', avance: 75, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-005', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Agendar dos reuniones intermedias con la Dra. Vigil', descripcion: 'Coordinacion de reuniones intermedias con la Dra. Vigil: primera realizada el 3 de julio; segunda programada para el 26 de julio.', responsable: 'JAIME', avance: 60, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-006', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Fortalecer analisis de comision escalonada', descripcion: 'Construir el cruce entre costo de silla e ingreso por odontologa.', responsable: 'RICARDO', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-007', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Proyectar impacto financiero de tacticas comerciales y operativas', descripcion: 'Proyeccion financiera integrada del impacto de las tacticas (+8% seguimiento post consulta y programa de referidos) y cuantificacion de sillas subutilizadas.', responsable: 'RICARDO', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-008', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Agregar media aritmetica en tabla de facturacion', descripcion: 'Desarrollar politica de meta minima de produccion de $2,500 mensuales.', responsable: 'RICARDO', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-009', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Activar campana de referidos', descripcion: 'Contactar por WhatsApp o llamada directa desde telefono de la clinica a los 103 pacientes referidos identificados, con oferta del 10% de descuento por cada nuevo referido.', responsable: 'CECILIA', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-010', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Estimar pacientes adicionales por programa de referidos', descripcion: 'Estimacion del impacto del programa de referidos: +126 pacientes y +$4,904 mensuales, compartida con finanzas para su proyeccion.', responsable: 'CECILIA', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-011', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Corregir modelo de gestion comercial', descripcion: 'Correccion del modelo de gestion comercial: objetivo medible en dinero y responsable nombrado.', responsable: 'CECILIA', avance: 25, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  ...
  { id: 'cr-f2-20260615-013', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Construir grafica de ingreso real vs potencial perdido', descripcion: 'Grafica de ingreso real contra potencial perdido por capacidad ociosa, expresado en valores mensuales.', responsable: 'ELIAS', avance: 25, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-014', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Cuantificar ahorro por precontratos anuales con proveedores', descripcion: 'Cuantificacion de ahorro por precontratos anuales con proveedores y optimizacion de horarios de baja demanda (ahorro estimado de $1,964/mes).', responsable: 'ELIAS', avance: 50, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-06-23' },
  { id: 'cr-f2-20260615-015', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Registrar horas efectivas de la fase 2', descripcion: 'Comenzar a registrar horas efectivas de esta fase desde ya. No incluir horas del diagnostico.', responsable: 'TODOS', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-08-31' },
  { id: 'cr-f2-20260615-016', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Registrar uso de inteligencia artificial', descripcion: 'Cada vez que se use IA, registrar herramienta, proposito y URL del prompt en el cuadro de la seccion 4.', responsable: 'TODOS', avance: 100, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-08-31' },
  { id: 'cr-f2-20260615-017', grupo: 'Fase 2 - Desarrollo Plan de Trabajo', semana: '15-29 jun', actividad: 'Incluir recomendacion ambiental en informe final', descripcion: 'Al menos una recomendacion ambiental incluida dentro de las recomendaciones del informe final. No es documento aparte.', responsable: 'JAIME, ELIAS', avance: 25, horas: 8, fechaInicio: '2026-06-15', fechaFin: '2026-08-31' },
];

const CRONOGRAMA_PLAN_TRABAJO_20260713_TASKS = [
...
const CRONOGRAMA_DEFAULT_TASKS = [
  ...
  { id: 'cr-005', grupo: 'Fase 1 - Diagnostico', actividad: 'Visita de campo: organizacion y area comercial', descripcion: 'Validar organigrama, CRM, clientes, canales y area comercial.', responsable: 'CECILIA', avance: 100, fechaMeta: '2026-05-17', fechaRealizada: '2026-05-16' },
  { id: 'cr-006', grupo: 'Fase 1 - Diagnostico', actividad: 'Visita de campo: operaciones y finanzas', descripcion: 'Inventarios, procesos, journey del paciente y documentacion financiera.', responsable: 'RICARDO', avance: 100, fechaMeta: '2026-05-23', fechaRealizada: '2026-05-21' },
  ...
  { id: 'cr-007', grupo: 'Fase 1 - Diagnostico', actividad: 'Entrega interna del diagnostico al tutor', descripcion: 'Version consolidada para revision del tutor, al menos 8 dias antes de la entrega ISEADE.', responsable: 'JAIME', avance: 100, fechaMeta: '2026-05-24', fechaRealizada: '2026-06-01' },
  { id: 'cr-008', grupo: 'Fase 1 - Diagnostico', actividad: 'Reunion 2 con Tutor Roberto', descripcion: 'Presentacion consolidada de elementos solicitados por integrante y revision de soportes.', responsable: 'TODOS', avance: 100, fechaMeta: '2026-05-26', fechaRealizada: '2026-05-26' },
  { id: 'cr-009', grupo: 'Fase 1 - Diagnostico', actividad: 'Entrega ISEADE: diagnostico', descripcion: 'Entrega fisica anillada y digital del informe de diagnostico.', responsable: 'JAIME', avance: 100, fechaMeta: '2026-06-01', fechaRealizada: '2026-06-01' },
  ...
  ...CRONOGRAMA_PLAN_TRABAJO_20260713_TASKS,
